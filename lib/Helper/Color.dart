...
const Color primary =Color(0xff9a37e2);
const Color secondary = Color(0xfffcc53c);
const Color fontColor = Colors.black;
const Color grad1Color = Color(0xff9a37e2);
const Color grad2Color = Color(0xfffcc53c);
...
const Color darkColor = Color(0xfffcc53c);
const Color darkColor2 = Color(0xfffcc53c);
